...
SECRET_KEY = 'django-insecure-34stqa=7(=ifc4-2^%4#2r=@zxj$(mpx0jat^y5m_p5^5z7ajd'
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "saffana-firsta-footballshop.pbp.cs.ui.ac.id", "10.0.2.2"]
